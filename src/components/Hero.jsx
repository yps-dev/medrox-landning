...
// import { Scene, PerspectiveCamera, WebGLRenderer, BufferGeometry, PointsMaterial, Points, BufferAttribute } from 'three';
// import { ScrollParallax } from 'react-just-parallax';
// // Use direct paths if assets/index.js is not set up
...
//       gsap.gsap.from(buttonRef.current, {
//         opacity: 0,
//         y: 20,
//         duration: 0.8,
//         ease: 'power3.out',
...
//     if (logoRef.current) {
//       gsap.gsap.from(logoRef.current, {
//         opacity: 0,
//         scale: 0.5,
//         duration: 1.5,
...
//     if (robotRef.current) {
//       gsap.gsap.from(robotRef.current, {
//         opacity: 0,
//         y: 100,
//         duration: 1.2,
//         ease: 'power3.out',
...
//     if (iconsRef.current) {
//       gsap.gsap.from(iconsRef.current.children, {
//         opacity: 0,
//         x: -50,
//         stagger: 0.1,
//         duration: 0.8,
...
//       gsap.gsap.from(notificationRef.current, {
//         opacity: 0,
//         x: 50,
//         duration: 0.8,
//         ease: 'power2.out',
...
//     cursor.className = 'fixed w-6 h-6 rounded-full bg-cyan-500/50 pointer-events-none z-50';
...
//           </p>
//           <Button ref={buttonRef} href="/pricing" white>
//             Get started
//           </Button>
//         </div>
