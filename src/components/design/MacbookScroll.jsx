...
export const MacbookScroll = ({
    ...
    return (
        <div
            ref={ref}
            className="flex min-h-[200vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:py-80 pb-32">
            <motion.h2
                style={{
    ...
    return (
        <div className="relative [perspective:800px]">
            ...
            <motion.div
                ...
                <video // Changed to video tag for video playback
                    src={src}
                    autoPlay
                    muted
                    loop
